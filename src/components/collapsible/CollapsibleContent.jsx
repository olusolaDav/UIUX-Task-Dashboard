...
//variables for collapsible component
const STATUS = {
    COLLAPSED: 'COLLAPSED',
...
function CollapsibleContent({
  ...
  //declaring collapsible state
  const [status, setStatus] = useState(
    expanded ? STATUS.EXPANDED : STATUS.COLLAPSED
  );

  //calling "useScrollHeight" from "react-collapsible-content" and pass sidebar container-ref inside it
  ...
  //switch conditional statement for the sideBar state
